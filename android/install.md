...
Feel free to check out the `/example` projects [`android/build.gradle`](https://github.com/msi89/mapbox-react-native/blob/main/example/android/build.gradle) for inspiration!
...
Feel free to check em out [here](https://github.com/msi89/mapbox-react-native/blob/eca4858744cab134b06ae455bcdacc63233318a5/android/rctmgl/build.gradle#L55-L76)
