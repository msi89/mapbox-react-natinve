...
<p align="center">
  <a href="https://github.com/msi89/mapbox-react-native/blob/main/example/src/examples/FillRasterLayer/ChoroplethLayerByZoomLevel.js">
    <img  src="readme_assets/example_choropleth_layer.png"  width="175"/>
  </a>
  <a href="https://github.com/msi89/mapbox-react-native/blob/main/example/src/examples/SymbolCircleLayer/Earthquakes.tsx">
    <img  src="readme_assets/example_clustering_earthquakes.png" width="175"/>
  </a>
  <a href="https://github.com/msi89/mapbox-react-native/blob/main/example/src/examples/Annotations/CustomCallout.tsx">
    <img  src="readme_assets/example_custom_callout.png" width="175"/>
  </a>
  <a href="https://github.com/msi89/mapbox-react-native/blob/main/example/src/examples/SymbolCircleLayer/DataDrivenCircleColors.js">
    <img  src="readme_assets/example_data_driven_circle_colors.png" width="175"/>
  </a>
  <a href="https://github.com/msi89/mapbox-react-native/blob/main/example/src/examples/FillRasterLayer/ImageOverlay.js">
...
*Note:* this app is using [non-trivial babel/metro configs](https://github.com/msi89/mapbox-react-native/pull/778), so we can consume the `maps` library from parent directory directly. Regular apps don't need this complicated setup.
...
* Android: Set up your Mapbox developer keys as described in https://github.com/msi89/mapbox-react-native/blob/main/android/install.md#adding-mapbox-maven-repo (no need to change build.gradle, just set up gradle.properties)

* iOS: Set up your Mapbox developer keys as described in [https://github.com/msi89/mapbox-react-native/blob/main/ios/install.md#adding-mapbox-maven-repo](https://github.com/msi89/mapbox-react-native/blob/main/ios/install.md#mapbox-maps-sdk-v10) (add your cerdentials to .netrc as described)
...
*Note*: if modules were added to base lib you might need to run `yarn start --reset-cache` because we're using `babel` to [rewrite imports](https://github.com/msi89/mapbox-react-native/pull/778)
